...
public class Users extends JFrame {
    ...
    public static ServerDaoRemote lookUpSalleDaoRemote() throws NamingException {
		...
		return (ServerDaoRemote) context.lookup("ejb:earweb/Server/ServiceDao!dao.ServerDaoRemote");}
	/**
	...
	public Users() {
		...
		lblNewLabel.setBounds(0, 20, 53, 14);
		panel.add(lblNewLabel);
		
		nomField = new JTextField();
		nomField.setFont(new Font("Tw Cen MT", Font.PLAIN, 11));
		nomField.setBounds(149, 13, 135, 21);
		panel.add(nomField);
		...
		btnNewButton.setBounds(405, 79, 121, 33);
		...
		btnNewButton_1.setBounds(405, 33, 121, 33);
		...
		lblNewLabel_1_1_1.setBounds(0, 52, 53, 14);
		...
		lblNewLabel_1_1_1_1.setBounds(0, 120, 149, 14);
		panel.add(lblNewLabel_1_1_1_1);
		
		dateChooser = new JDateChooser();
		dateChooser.setBounds(149, 114, 135, 20);
