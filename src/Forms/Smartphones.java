...
public class Smartphones extends JFrame {
	...
	public Smartphones() {
		...
		lblNewLabel_1.setFont(new Font("Sitka Subheading", Font.PLAIN, 17));
		lblNewLabel_1.setBounds(101, 55, 64, 24);
		panel.add(lblNewLabel_1);
		
		imeiField = new JTextField();
		imeiField.setFont(new Font("Tw Cen MT", Font.PLAIN, 21));
		imeiField.setBackground(Color.WHITE);
		imeiField.setBounds(190, 24, 135, 20);
		panel.add(imeiField);
		imeiField.setColumns(10);
		
		
		JButton btnNewButton = new JButton("ADD");
		btnNewButton.setFont(new Font("Tempus Sans ITC", Font.PLAIN, 21));
		...
		btnNewButton.setBounds(431, 23, 121, 23);
		...
		UserComboBox.setBounds(190, 55, 135, 24);
		panel.add(UserComboBox);
		
		JButton btnNewButton_1 = new JButton("UPDATE");
		btnNewButton_1.setForeground(Color.RED);
		btnNewButton_1.setFont(new Font("Verdana", Font.PLAIN, 21));
		...
		btnNewButton_1.setBounds(321, 124, 126, 23);
		panel.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("DELETE");
		btnNewButton_2.setForeground(Color.RED);
		btnNewButton_2.setFont(new Font("Tempus Sans ITC", Font.PLAIN, 21));
		...
		btnNewButton_2.setBounds(514, 124, 107, 23);
